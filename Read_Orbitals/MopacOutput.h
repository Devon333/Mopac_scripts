...
//        vector<vector<string> > MOvec(numOfMOs,vector<string>(numOfMOs));
      ...
      //CLASS CONSTRUCTORS 
       MopacOutput(string filename, string hamiltonian, string debug){
           MOs(filename);
...
void MopacOutput::SD_energies(string filename)
{
...
void MopacOutput::CI_energies(string filename)
{
    //Contains all the lines of the output file##########
    vector<string> lines;                           //###
    ifstream InFile;                                //###
...
void MopacOutput::CI_coeff(string filename)
{
    //Contains all the lines of the output file##########
    vector<string> lines;                           //###
    ifstream InFile;                                //###
...
vector<vector<double> > MopacOutput::CI_midpoint(vector<vector<double> > mat1, vector<vector<double> > mat2)
{
...
vector<vector<double> > MopacOutput::average_matrix(vector<vector<double> > mat1, vector<vector<double> > mat2, vector<int> active_space)
{
...
void MopacOutput::write_Hvib_matrix_preCI(string base_path, int t, vector<int> active_space, vector<vector<int> > sd_basis, vector<vector<double> >nac_mat)
{
...
void MopacOutput::write_Hvib_matrix(string base_path, int t, vector<int> active_space, vector<vector<int> > sd_basis, vector<vector<double> >nac_mat)
{
    vector<int> indexVec,indexVec2;
...
void MopacOutput::write_re_matrix(string file_path, int time, vector<vector<double> > matrix)
{
    ofstream mat_file; 
...
void MopacOutput::write_im_matrix(string file_path, int time, vector<vector<double> > matrix)
{
    ofstream mat_file; 
...
vector<vector<double> > MopacOutput::overlap(vector<vector<double> > time_point1, vector<int> active_space)
{
    clock_t start, end;
    start = clock();
...
vector<vector<double> > MopacOutput::time_overlap(vector<vector<double> > time_point1, vector<vector<double> > time_point2, double step_size, vector<int> active_space)
{
    clock_t start, end;
    start = clock();
    ios_base::sync_with_stdio(true);
...
vector<vector<double> > MopacOutput::central_diff_deriv(vector<vector<double> > time_point1, vector<vector<double> > time_point2, double step_size, vector<int> active_space)
{
...
vector<vector<int> > MopacOutput::copy_CImap(map<int, vector<int> > m)
{
...
vector<vector<double> > MopacOutput::copy_CImap(map<int, vector<double> > m)
{
...
vector<vector<double> > MopacOutput::copy_CImap(map<int, double > m)
{
...
vector<vector<double> > MopacOutput::copy_map(map<int, vector<double> > m)
{
...
vector<vector<double> > MopacOutput::copy_map(map<int, double > m)
{
...
void MopacOutput::print_map(string comment, map<int, vector<double> > m)
{
    cout << comment << "{ " ;
    for (map<int, vector<double>>::const_iterator key=m.begin();key != m.end(); key++) 
    {
...
void MopacOutput::print_map(string comment, map<int, vector<int>> m)
{
    cout << comment << "{ " ;
    for (map<int, vector<int>>::const_iterator key=m.begin();key != m.end(); key++) 
    {
...
void MopacOutput::print_map(string comment, map<int, double> m)
{
    std::cout << comment;
...
void MopacOutput::Read(string name)
{
//Contains all the lines of the output file##########
//vector<string> lines;                           //###
ifstream InFile;                                //###
...
void MopacOutput::MOs(string filename)
{
    //Contains all the lines of the output file##########
    vector<string> lines;                           //###
    ifstream InFile;                                //###
