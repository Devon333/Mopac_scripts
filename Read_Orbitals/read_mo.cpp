...
//    cin >> base_filename;
//
//    cout << "how many time steps are in the trajectory " << endl;
//    cin >> time_steps;
...
//commenting starts here
        ...
        do{
              vector<vector<double> > avg_Eig;
              vector<vector<double> > nac_mat;
              vector<vector<double> > t_overlap_mat;
              ...
              t_overlap_mat=info1.time_overlap(MOs1, MOs2,active_space);
              nac_mat=info1.central_diff_deriv(MOs1, MOs2, step_size, active_space);
              avg_Eig=info1.average_matrix(Eig1,Eig2,active_space);              
              info1.write_re_matrix(base_filename+"_St", t, t_overlap_mat);  
              info1.write_re_matrix(base_filename+"_E", t, avg_Eig);
